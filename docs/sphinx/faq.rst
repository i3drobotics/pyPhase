...
**Solution:**
   ...
   **Linux**
   ...
   Download debian package from `v0.0.20 release <https://github.com/i3drobotics/phase/releases/tag/v0.0.20>`_.
   ...
   **Windows**
   ...
   Download Windows installer from the `v0.0.20 release <https://github.com/i3drobotics/phase/releases/tag/v0.0.20>`_.
