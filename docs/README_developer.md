...
>### Linux
>Download debian package from [v0.1.2-12 release](https://github.com/i3drobotics/phase/releases/tag/v0.1.2-12).  
...
>### Windows
>Download Windows installer from the [v0.1.2-12 release](https://github.com/i3drobotics/phase/releases/tag/v0.1.2-12).  
